...
create_index "JunctionAlpha" "id"
create_index "VBeta" "gene"
create_index "VBeta" "allele"
create_index "JBeta" "gene"
create_index "JBeta" "allele"
create_index "JunctionBeta" "id"
create_index "Clone" "junction_a_nt"
create_index "Clone" "junction_b_nt"
create_index "Repertoire" "replicate"
create_index "Repertoire" "tissue"
create_index "Repertoire" "disease_state"
create_index "Repertoire" "sample_size"
create_index "Repertoire" "sample_filename"
